...
export default function TeamLeadLeavesPage() {
  ...
  const fetchLeaves = async () => {
    try {
      ...
      // Fetch all leaves for calendar view
      const allResponse = await fetch("/api/leaves/team")
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="pending" className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="calendar">Team Leave Calendar</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="calendar" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                View all leaves for your team members
              </CardDescription>
            </CardHeader>
            <CardContent>
              {allLeaves.length === 0 ? (
                    ...
                    return (
                      <div key={month} className="space-y-3">
                        <h3 className="font-semibold text-lg border-b pb-2">
                          {format(new Date(2024, month - 1, 1), "MMMM yyyy")}
                        </h3>
